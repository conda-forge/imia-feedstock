...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/imia-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14085&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/imia-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `imia` can be installed with:

```
conda install imia
```

It is possible to list all of the versions of `imia` available on your platform with:
